...
// console.log(lettersMix.sort()); // ['A', 'B', 'E', 'F', 'c', 'd', 'g']
...
// // ascending
console.log('ascending sort: ', moreNumbers.sort((a, b) => {
    console.log({a}, {b})
    a - b
})); // a = 1000 - b = 10 === positive

// // descending
console.log('descending sort: ', moreNumbers.sort((a, b) => {
    console.log({a}, {b})
    b - a
})); // b = 1000 - a = 10 === negative
