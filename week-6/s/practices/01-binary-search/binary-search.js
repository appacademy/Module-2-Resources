...
// console.log(linearSearch([2,4,6,8], 6));// 6
...
console.log(binarySearch([2, 4, 6, 8, 9, 10, 12, 15], 10)); // 5
/*

  [2, 4, 6, 8, 9, 10, 12, 15]  Low: 0 | mid:0 | high: -1| target: 5

    [2, 4, 6, 8, 9, 10, 12, 15]  Low: 0 | mid:0 | high: -1| target: 1
