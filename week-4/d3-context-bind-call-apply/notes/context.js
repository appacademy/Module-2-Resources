...
// // const shanesThis = narwhal.sayAge.bind(shane)
...
const shaneFunc = sayAgeFunc.bind(shane);
const garyFunc = sayAgeFunc.bind(gary);
// console.log(this); // Global object
garyFunc() // 'my name is undefined and i am undefined'
